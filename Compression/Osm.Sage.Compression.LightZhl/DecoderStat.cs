...
public class DecoderStat : IHuffStat
{
    ...
    [
        ...
        new() { NBits = 4, Pos = 68 }, new() { NBits = 4, Pos = 84 }, new() { NBits = 4, Pos = 100 },
        new() { NBits = 4, Pos = 116 }, new() { NBits = 4, Pos = 132 }, new() { NBits = 4, Pos = 148 },
        new() { NBits = 4, Pos = 164 }, new() { NBits = 5, Pos = 180 }, new() { NBits = 5, Pos = 212 },
        new() { NBits = 5, Pos = 244 },
    ];
